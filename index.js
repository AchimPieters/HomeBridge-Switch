...
module.exports = function (homebridge) {
    ...
    homebridge.registerAccessory("homebridge-Switch", "HTTP-SWITCH", HTTP_SWITCH);
}
...
HTTP_SWITCH.prototype = {
    ...
    getServices: function () {
        ...
        informationService
                ...
                .setCharacteristic(Characteristic.Model, "homebridge-switch")
                .setCharacteristic(Characteristic.SerialNumber, "SP07022017");
